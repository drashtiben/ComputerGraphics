...
import finalproject.raytracing.rendering.AnimationRenderer;
...
public class AnimationPanel extends JPanel {
    public AnimationPanel(Viewport viewport, SettingsPanel settingsPanel) {
        ...
        btnFirstPos = new JButton("Place First Location");
        gbcPanel0.gridx = 0;
        gbcPanel0.gridy = 1;
        ...
        btnSecondPos = new JButton("Place Second Location");
        gbcPanel0.gridx = 1;
        gbcPanel0.gridy = 1;
        gbcPanel0.gridwidth = 1;
        gbcPanel0.gridheight = 1;
        ...
        lbLabel1 = new JLabel("Final Resolution (%)");
        gbcPanel0.gridx = 0;
        gbcPanel0.gridy = 3;
        gbcPanel0.gridwidth = 1;
        gbcPanel0.gridheight = 1;
        ...
        btnStart = new JButton("Rendering Image Series");
        gbcPanel0.gridx = 0;
        gbcPanel0.gridy = 4;
        ...
        btnStart.addActionListener(e -> {
            File outputDir = new File("Series of Image");
            if (!outputDir.exists())
                outputDir.mkdir();
