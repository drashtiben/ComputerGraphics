package finalproject.raytracing.gui;

import finalproject.raytracing.math.Vector3;
import finalproject.raytracing.pixeldata.Color;
import finalproject.raytracing.rendering.Renderer;
import finalproject.raytracing.rendering.Scene;
import finalproject.raytracing.rendering.Skybox;
import finalproject.raytracing.solids.Plane;
import finalproject.raytracing.solids.Sphere;
...
public class SettingsPanel extends JPanel {
    ...
    public SettingsPanel(Viewport viewport, JDialog animationDialog) {
        ...
        lbLightHA = new JLabel("Horizontal Angle of Light");
        gbc.gridx = 0;
        gbc.gridy = 8;
        gbc.gridwidth = 2;
        gbc.gridheight = 1;
        ...
        lbLighVA = new JLabel("Vertical Angle of Light");
        gbc.gridx = 0;
        gbc.gridy = 10;
        gbc.gridwidth = 2;
        gbc.gridheight = 1;
        ...
        lbLightDist = new JLabel("Distance of Light");
        gbc.gridx = 0;
        gbc.gridy = 12;
        gbc.gridwidth = 2;
        gbc.gridheight = 1;
