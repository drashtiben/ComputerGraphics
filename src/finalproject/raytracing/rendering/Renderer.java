...
public class Renderer {
     ...
     *  width The width of the desired output
     *  height The height of the desired output
     * The rendered PixelBuffer
     */
    public static BufferingPixel renderScene(Scene scene, int width, int height) {
        BufferingPixel pixelBuffer = new BufferingPixel(width, height);
     ...
     * scene The scene to Render
     * For expected output,  width The width
     * height The height of the expected output
     * Controls the number of rays traced. (1 = Every pixel is ray-traced)
     */
    ...
    public static void renderScenePostProcessed(Scene scene, Graphics gfx, int width, int height, float resolution) {
        ...
        BufferingPixel pixelBuffer  = renderScene(scene, bufferWidth, bufferHeight);

        BufferingPixel emissivePixels = pixelBuffer.clone(); // The width of this buffer has to remain constant to keep the blur factor the same for all sizes
    ...
    /** Getting OpenGL style screen coordinates where (0,0) is the center of the screen from x, y coordinates that start from the top-left corner of the screen */
